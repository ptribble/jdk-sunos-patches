...
@@ -2144,7 +2144,7 @@ void os::pd_commit_memory_or_exit(char*
...
@@ -2171,7 +2173,7 @@ void os::pd_realign_memory(char *addr, s
...
@@ -2179,7 +2182,7 @@ void os::numa_make_local(char *addr, siz
