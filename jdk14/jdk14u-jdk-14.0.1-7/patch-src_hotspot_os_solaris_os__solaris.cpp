...
@@ -2155,7 +2155,7 @@ void os::pd_commit_memory_or_exit(char*
...
@@ -2184,7 +2184,7 @@ void os::pd_realign_memory(char *addr, s
...
@@ -2189,7 +2192,7 @@ void os::numa_make_local(char *addr, siz
