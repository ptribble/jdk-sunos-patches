...
@@ -2133,7 +2135,7 @@ void os::pd_commit_memory_or_exit(char*
...
@@ -2162,7 +2164,7 @@ void os::pd_realign_memory(char *addr, s
...
@@ -2170,7 +2172,7 @@ void os::numa_make_local(char *addr, siz
