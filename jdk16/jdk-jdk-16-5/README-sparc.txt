...
Errors associated with undefined CodeCache. What's happened here is
that the
#include "code/codeCache.hpp"
has been moved around a bit elsewhere, so SPARC no longer picks it
up. Added it to frame_sparc.inline.hpp.
