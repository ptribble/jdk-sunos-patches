...
These are current and tested for jdk 18+28. They don't provide a
...
gpatch -p1 < ${THOME}/build/patches/openjdk18/illumos-zero-1.patch
gpatch -p1 < ${THOME}/build/patches/openjdk18/illumos-zero-2.patch
